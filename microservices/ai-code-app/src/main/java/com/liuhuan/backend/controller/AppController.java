...
import com.liuhuan.backend.common.DeleteRequest;
...
public class AppController {
    ...
    @RateLimit(limitType = RateLimitType.USER, message = "AI 对话请求过于频繁，请稍后再试")
    ...
    public BaseResponse<Page<AppVO>> listMyAppVOByPage(@RequestBody AppQueryRequest appQueryRequest, HttpServletRequest request) {
        ...
        long pageNum = appQueryRequest.getCurrentPage();
        // 只查询当前用户的应用
    ...
    @Cacheable(
            value = "good_app_page",
            key = "T(com.liuhuan.backend.utils.CacheKeyUtils).generateKey(#appQueryRequest)",
